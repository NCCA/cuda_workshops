...
cudaIntr.commands = $$CUDA_DIR/bin/nvcc -m64 -g -G $$CUDA_INC $$NVCCFLAGS -gencode arch=compute_$$CUDA_COMPUTE_ARCH,code=sm_$$CUDA_COMPUTE_ARCH -dc $$CUDA_INC $$LIBS ${QMAKE_FILE_NAME} -o ${QMAKE_FILE_OUT}
