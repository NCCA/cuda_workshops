// Original Utah teapot bezier patches, sourced from:
...
// Define a namespace for the teapot data
namespace teapot {

// This is the number of patches in the file
const unsigned int num_patches = 10;

// The patches (remember, there are 16 control points in each patch)
const unsigned int patches[160]= 
...
// The number of vertices in the teapot data set
const unsigned int num_vertices = 127;

// The vertex data (flattened) - 3 values for each vertex (x,y,z)
const float vertices[381] = 
